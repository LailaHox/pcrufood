...
class _AddFoodMenuState extends State<AddFoodMenu> {
  ...
  Future<void> uploadFoodAndInsertData() async {
    ...
    try {
      ...
      await Dio().post(urlUpload, data: formData).then((value) async {
        String urlPathImage = '/foodapp/Food/$nameFile';
        ...
        String urlInsertData =
            '${MyConstant().domain}/foodapp/addFood.php?isAdd=true&idShop=$idShop&NameFood=$nameFood&PathImage=$urlPathImage&Price=$price&Detail=$detail';
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          height: 250.0,
          child: file == null
              ? Image.asset('images/logomenu.png')
              : Image.file(file!),
        ),
        IconButton(
